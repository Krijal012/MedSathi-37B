...
const AdminHeader = ({ adminName = "Admin", toggleSidebar }) => {
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center">
                    ...
                    <h2 className="text-sm text-gray-500 hidden sm:block">
                        Welcome back, <span className="font-semibold text-gray-700">{adminName}</span>
                    </h2>
                </div>
                <div className="flex items-center space-x-2 sm:space-x-4">
                    <div className="flex items-center space-x-2 cursor-pointer">
                        ...
                        <span className="font-medium text-gray-700 hidden md:block">{adminName}</span>
                    </div>
                    <button
