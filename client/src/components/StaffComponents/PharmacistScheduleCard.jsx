...
const PharmacistScheduleCard = ({ pharmacistName, specialty, schedule = {} }) => {
    ...
    return (
        <div className="bg-white rounded-2xl p-6 shadow-[0_4px_20px_rgba(0,0,0,0.05)] border border-gray-100 mb-6 group hover:shadow-[0_8px_30px_rgba(0,0,0,0.12)] transition-all duration-300">
            <div className="flex items-center space-x-5 mb-8">
                ...
                <div>
                    <h4 className="text-xl font-bold text-[#1e293b] leading-tight mb-1">{pharmacistName}</h4>
...
export default PharmacistScheduleCard;